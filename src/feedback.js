...
container.addEventListener('click', (event) => {
      ...
      if (infoBtn) {
        ...
        closeAllHints();
        if (!isOpen) {
          hint.classList.add('fb-hint-open');
          infoBtn.classList.add('is-active'); // Робимо кнопку білою!
        }
        return;
      }
...
// ── Клік по кнопці "Обрати іншу станцію" ──
...
// ── Клік по елементах позицій (відновлення/закриття виходу) ──
