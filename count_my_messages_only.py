...
# Назва відправника у логах Signal Desktop за замовчуванням
MY_NAME = "Me"
...
for file_path in chats_dir.glob("**/*.md"):
    with open(file_path, "r", encoding="utf-8", errors="ignore") as f:
        for line in f:
            ...
            # Враховуємо лише ваші повідомлення
            if sender.lower() != MY_NAME.lower():
                continue

            # Очищення від лінків та медіа-файлів
...
print("\n" + "="*45)
print(f" ПІДРАХУНОК ЗНАКІВ ЛИШЕ У ВАШИХ РЕПЛІКАХ: {total_symbols}")
print("="*45 + "\n")
